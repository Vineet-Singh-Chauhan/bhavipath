...
<footer className="p-4 sm:p-6 bg-gray-900/50 backdrop-blur-lg">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <a href="/" className="hover:underline">DISC Test</a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="/" className="hover:underline">Bhavipath</a>. All Rights Reserved.
        </span>
