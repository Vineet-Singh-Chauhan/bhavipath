...
function Aboutuspage() {
    return (
        <div>
            ...
            <h1 data-aos="fade-zoom-in" className="px-4 my-10 text-center mb-10 text-4xl font-bold tracking-tight leading-none  bg-gradient-to-r from-[#CB356B] to-[#BD3F32] bg-clip-text md:text-5xl lg:text-6xl text-transparent">We invest in the world’s potential</h1>
