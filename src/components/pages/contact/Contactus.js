	...
	<div className="container mx-auto my-4 px-4 lg:px-20">
		...
		<div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
			...
			<div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
				<input className="w-full   mt-2 p-3 rounded bg-[#3e3f3f]/50 text-white focus:bg-[#3e3f3f]/70 focus:outline-none focus:shadow-outline"
            type="text" placeholder="First Name*" />
				<input className="w-full bg-none  mt-2 p-3 rounded bg-[#3e3f3f]/50 text-white focus:bg-[#3e3f3f]/70 focus:outline-none focus:shadow-outline"
            ...
            type="number" placeholder="Phone*" />
				...
				<div className="my-4">
					<textarea placeholder="Message*" className="w-full h-32   mt-2 p-3 rounded bg-[#3e3f3f]/50 text-white focus:bg-[#3e3f3f]/70 focus:outline-none focus:shadow-outline"></textarea>
				</div>
				<div className="my-2 w-1/2 lg:w-1/4">
					<button className="uppercase text-sm font-bold tracking-wide bg-blue-900  p-3 rounded  text-white hover:bg-blue-900/90 w-full 
			...
			<div
				className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-blue-900 rounded">
